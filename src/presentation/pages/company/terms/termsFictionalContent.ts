...
const es: TermsBundle = {
  ...
  lastUpdated: "Última actualización: 3 de junio de 2026 — Versión 1.0",
  disclaimer:
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "«Propuesta de Servicios»: Documento específico con alcance, entregables, precio cerrado y plazos del servicio particular contratado por el Cliente, enviado dentro de las 24 horas siguientes a la solicitud de cotización. Forma parte integral de los presentes Términos.",
    ...
    },
    {
      ...
      paragraphs: [
        "Stratium Legal ofrece servicios legales corporativos especializados en el cumplimiento de las obligaciones establecidas por la LGSM, el CFF y el Código de Comercio para toda persona moral en México. Los servicios cubren el ciclo de vida corporativo completo, desde la constitución de la empresa hasta su mantenimiento anual continuo, y se organizan en los siguientes planes:",
        "3.1 Plan Starter — Fundación. Precio: $8,000.00 MXN (Ocho Mil Pesos 00/100 M.N.) más IVA. Precio base; pago único. Diseñado para emprendedores y empresas que buscan iniciar con bases legales sólidas desde el día uno. Incluye:",
        ...
        "3.2 Plan Cumplimiento Mensual — Abogado in-house virtual. Precio: $15,000.00 MXN (Quince Mil Pesos 00/100 M.N.) mensuales más IVA. Suscripción mensual. Funciona como un abogado corporativo in-house sin los costos de uno. Cubre las obligaciones corporativas y laborales de la empresa de forma continua. Incluye:",
        ...
        "La suscripción se renueva automáticamente cada mes salvo que el Cliente notifique su cancelación con al menos quince (15) días naturales de anticipación al inicio del siguiente periodo. No incluye: representación ante autoridades judiciales o administrativas en litigios, gestiones migratorias, registro de marcas, opiniones legales formales sobre operaciones extraordinarias (M&A, reestructuraciones) ni servicios de auditoría fiscal.",
        "3.3 Plan Soft Landing — Empresas extranjeras. Precio: $30,000.00 MXN (Treinta Mil Pesos 00/100 M.N.) más IVA. Pago único o por etapas, según Propuesta de Servicios. Diseñado para empresas extranjeras que buscan establecerse en México de forma segura, eficiente y conforme a la legislación mexicana. Incluye:",
        ...
        "3.4 Servicios adicionales y especializados. Además de los planes descritos, Stratium Legal ofrece los siguientes servicios que pueden contratarse de forma independiente o complementaria:",
        ...
        "• Servicios de propiedad intelectual, fusiones y adquisiciones, debida diligencia y contratos especializados, sujetos a cotización específica.",
        "El alcance, entregables y precio cerrado de estos servicios se establecerán en la Propuesta de Servicios correspondiente, la cual se entrega al Cliente dentro de las 24 horas siguientes a la solicitud.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "2. Propuesta en 24 horas: Stratium Legal envía al Cliente una Propuesta de Servicios con alcance, entregables y precio cerrado, sin letras chiquitas, sin costos ocultos y sin compromisos previos.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "3. Entregar la Propuesta de Servicios dentro de las veinticuatro (24) horas siguientes a la solicitud de cotización, con alcance, entregables y precio cerrado.",
    ...
    },
    {
      ...
      paragraphs: [
        "7.1 Precios de los planes de servicio. Los precios vigentes son los siguientes:",
        "• Plan Starter: $8,000.00 MXN (precio base) más IVA, pago único. Incluye constitución de sociedad, libros corporativos, registro de socios, primera acta y entrega digital.",
        "• Plan Cumplimiento Mensual: $15,000.00 MXN/mes más IVA, suscripción mensual. Incluye asamblea anual, poderes, asesoría corporativa continua, gestión laboral, soporte 24h y recordatorios.",
        "• Plan Soft Landing: $30,000.00 MXN más IVA, pago único o por etapas. Incluye diagnóstico, constitución, libros, asesoría fiscal, apertura bancaria, poderes y orientación laboral/migratoria.",
        "Los precios no incluyen IVA, el cual será trasladado al Cliente conforme a la legislación fiscal vigente. Los precios incluyen asesoría personalizada y entrega digital con plena validez legal. Stratium Legal se reserva el derecho de modificar los precios, notificando al Cliente con al menos treinta (30) días naturales de anticipación. Las modificaciones no afectarán servicios ya contratados y pagados.",
        "7.2 Gastos reembolsables. El Cliente cubrirá los gastos razonables y documentados, incluyendo:",
        ...
        "7.3 Facturación y pago. Stratium Legal emitirá CFDI conforme a la legislación fiscal vigente. El pago de los Planes Starter y Soft Landing (pago único) se realiza previo a la prestación del servicio, salvo pago por etapas pactado en la Propuesta de Servicios. El pago del Plan Cumplimiento Mensual se realiza dentro de los cinco (5) días naturales siguientes al inicio de cada periodo mensual. Los pagos se realizan mediante transferencia electrónica a la cuenta que Stratium Legal designe. Todos los honorarios se expresan en Pesos Mexicanos (MXN).",
        "7.4 Mora en el pago. En caso de mora, se generarán intereses moratorios a una tasa equivalente al doble de la TIIE a 28 días vigente a la fecha de vencimiento, por día de atraso sobre el saldo insoluto. Stratium Legal podrá suspender los Servicios si el atraso excede quince (15) días naturales, previa notificación al Cliente con al menos cinco (5) Días Hábiles de anticipación.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• Multas o sanciones derivadas de incumplimientos previos a la contratación de los Servicios (como las multas de hasta $208,070 MXN por año incumplido referidas en el artículo 83 del CFF, cuya regularización es objeto de los Servicios pero cuya imposición depende exclusivamente de las autoridades fiscales).",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "12.1 Vigencia. Los presentes Términos entran en vigor a partir de su aceptación y permanecen vigentes mientras exista relación profesional entre las Partes. Para el Plan Cumplimiento Mensual, la suscripción se renueva automáticamente cada mes. Para los Planes Starter y Soft Landing, la relación termina con la entrega completa de los entregables pactados.",
        "12.2 Cancelación por el Cliente. El Cliente podrá cancelar los Servicios en cualquier momento, mediante notificación por escrito (correo electrónico a info@stratiumlegal.com) con al menos quince (15) días naturales de anticipación. En caso de cancelación del Plan Cumplimiento Mensual, no habrá reembolso del mes en curso. En los Planes Starter o Soft Landing, el Cliente cubrirá los honorarios devengados y los gastos ya incurridos.",
...
const en: TermsBundle = {
  ...
  lastUpdated: "Last updated: June 3, 2026 — Version 1.0",
  disclaimer:
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "“Service Proposal”: A specific document with the scope, deliverables, fixed price, and timelines of the particular service contracted by the Client, sent within 24 hours following the quote request. It forms an integral part of these Terms.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "3.1 Starter Plan — Foundation. Price: $8,000.00 MXN (Eight Thousand Pesos 00/100 M.N.) plus VAT. Base price; one-time payment. Designed for entrepreneurs and companies seeking to start with solid legal foundations from day one. Includes:",
        ...
        "3.2 Monthly Compliance Plan — Virtual in-house lawyer. Price: $15,000.00 MXN (Fifteen Thousand Pesos 00/100 M.N.) monthly plus VAT. Monthly subscription. It works like an in-house corporate lawyer without the cost of one. It covers the company's corporate and labor obligations on an ongoing basis. Includes:",
        ...
        "The subscription renews automatically each month unless the Client provides notice of cancellation at least fifteen (15) calendar days before the start of the next period. Not included: representation before judicial or administrative authorities in litigation, immigration procedures, trademark registration, formal legal opinions on extraordinary transactions (M&A, restructurings), or tax audit services.",
        "3.3 Soft Landing Plan — Foreign companies. Price: $30,000.00 MXN (Thirty Thousand Pesos 00/100 M.N.) plus VAT. One-time or staged payment, according to the Service Proposal. Designed for foreign companies seeking to establish themselves in Mexico safely, efficiently, and in compliance with Mexican law. Includes:",
        ...
        "3.4 Additional and specialized services. In addition to the plans described, Stratium Legal offers the following services that may be contracted independently or as a complement:",
        ...
        "• Intellectual property, mergers and acquisitions, due diligence, and specialized contract services, subject to a specific quote.",
        "The scope, deliverables, and fixed price of these services will be set out in the corresponding Service Proposal, which is delivered to the Client within 24 hours of the request.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "2. Proposal within 24 hours: Stratium Legal sends the Client a Service Proposal with scope, deliverables, and fixed price — no fine print, no hidden costs, and no prior commitments.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "3. Deliver the Service Proposal within twenty-four (24) hours of the quote request, with scope, deliverables, and fixed price.",
    ...
    },
    {
      ...
      paragraphs: [
        "7.1 Service plan prices. The current prices are as follows:",
        "• Starter Plan: $8,000.00 MXN (base price) plus VAT, one-time payment. Includes incorporation of the company, corporate books, partner registration, first minutes, and digital delivery.",
        "• Monthly Compliance Plan: $15,000.00 MXN/month plus VAT, monthly subscription. Includes annual meeting, powers of attorney, ongoing corporate advisory, labor management, 24h support, and reminders.",
        "• Soft Landing Plan: $30,000.00 MXN plus VAT, one-time or staged payment. Includes assessment, incorporation, books, tax advisory, bank account opening, powers of attorney, and labor/immigration guidance.",
        "Prices do not include VAT, which will be charged to the Client in accordance with applicable tax law. Prices include personalized advice and digital delivery with full legal validity. Stratium Legal reserves the right to modify prices, notifying the Client at least thirty (30) calendar days in advance. Modifications will not affect services already contracted and paid.",
        "7.2 Reimbursable expenses. The Client will cover reasonable and documented expenses, including:",
        ...
        "7.3 Billing and payment. Stratium Legal will issue a CFDI (tax invoice) in accordance with applicable tax law. Payment for the Starter and Soft Landing Plans (one-time payment) is made prior to the provision of the service, except for staged payment agreed in the Service Proposal. Payment for the Monthly Compliance Plan is made within five (5) calendar days following the start of each monthly period. Payments are made by electronic transfer to the account designated by Stratium Legal. All fees are expressed in Mexican Pesos (MXN).",
        "7.4 Late payment. In the event of default, late-payment interest will accrue at a rate equivalent to twice the 28-day TIIE in effect on the due date, per day of delay on the outstanding balance. Stratium Legal may suspend the Services if the delay exceeds fifteen (15) calendar days, after notifying the Client at least five (5) Business Days in advance.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• Fines or penalties arising from breaches prior to contracting the Services (such as fines of up to $208,070 MXN per year of non-compliance referred to in article 83 of the CFF, whose regularization is the object of the Services but whose imposition depends exclusively on the tax authorities).",
      ],
    },
    {
...
const ind: TermsBundle = {
  ...
  lastUpdated: "अंतिम अपडेट: 3 जून, 2026 — संस्करण 1.0",
  disclaimer:
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "'सेवा प्रस्ताव': ग्राहक द्वारा अनुबंधित विशेष सेवा के दायरे, सुपुर्दगियों, निश्चित मूल्य और समयसीमा के साथ एक विशिष्ट दस्तावेज़, जो कोटेशन अनुरोध के 24 घंटे के भीतर भेजा जाता है। यह इन नियमों का अभिन्न हिस्सा है।",
    ...
    },
    {
      ...
      paragraphs: [
        "Stratium Legal मेक्सिको में प्रत्येक कानूनी इकाई के लिए LGSM, CFF और वाणिज्यिक संहिता द्वारा स्थापित दायित्वों के अनुपालन में विशेषज्ञता वाली कॉर्पोरेट कानूनी सेवाएँ प्रदान करता है। ये सेवाएँ कंपनी के गठन से लेकर उसके निरंतर वार्षिक रखरखाव तक संपूर्ण कॉर्पोरेट जीवनचक्र को कवर करती हैं, और निम्नलिखित योजनाओं में संगठित हैं:",
        "3.1 Starter योजना — स्थापना। मूल्य: $8,000.00 MXN (आठ हज़ार पेसो 00/100 M.N.) प्लस VAT। आधार मूल्य; एकमुश्त भुगतान। उन उद्यमियों और कंपनियों के लिए डिज़ाइन किया गया जो पहले दिन से ठोस कानूनी आधार के साथ शुरुआत करना चाहते हैं। इसमें शामिल है:",
        ...
        "3.2 Cumplimiento Mensual योजना — वर्चुअल इन-हाउस वकील। मूल्य: $15,000.00 MXN (पंद्रह हज़ार पेसो 00/100 M.N.) मासिक प्लस VAT। मासिक सदस्यता। यह बिना लागत के एक इन-हाउस कॉर्पोरेट वकील की तरह काम करता है। यह कंपनी के कॉर्पोरेट और श्रम दायित्वों को निरंतर रूप से कवर करता है। इसमें शामिल है:",
        ...
        "सदस्यता हर महीने स्वचालित रूप से नवीनीकृत होती है, जब तक कि ग्राहक अगली अवधि की शुरुआत से कम से कम पंद्रह (15) कैलेंडर दिन पहले रद्द करने की सूचना न दे। शामिल नहीं: मुकदमों में न्यायिक या प्रशासनिक अधिकारियों के समक्ष प्रतिनिधित्व, आव्रजन प्रक्रियाएँ, ट्रेडमार्क पंजीकरण, असाधारण लेनदेन (M&A, पुनर्गठन) पर औपचारिक कानूनी राय, या कर ऑडिट सेवाएँ।",
        "3.3 Soft Landing योजना — विदेशी कंपनियाँ। मूल्य: $30,000.00 MXN (तीस हज़ार पेसो 00/100 M.N.) प्लस VAT। एकमुश्त या चरणबद्ध भुगतान, सेवा प्रस्ताव के अनुसार। उन विदेशी कंपनियों के लिए डिज़ाइन किया गया जो मेक्सिको में सुरक्षित, कुशल और मैक्सिकन कानून के अनुरूप स्थापित होना चाहती हैं। इसमें शामिल है:",
        ...
        "3.4 अतिरिक्त और विशेष सेवाएँ। वर्णित योजनाओं के अतिरिक्त, Stratium Legal निम्नलिखित सेवाएँ प्रदान करता है जिन्हें स्वतंत्र रूप से या पूरक रूप से अनुबंधित किया जा सकता है:",
        ...
        "• बौद्धिक संपदा, विलय और अधिग्रहण, सम्यक परिश्रम और विशेष अनुबंध सेवाएँ, विशिष्ट कोटेशन के अधीन।",
        "इन सेवाओं का दायरा, सुपुर्दगियाँ और निश्चित मूल्य संबंधित सेवा प्रस्ताव में निर्धारित किए जाएँगे, जो अनुरोध के 24 घंटे के भीतर ग्राहक को सौंपा जाता है।",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "2. 24 घंटे में प्रस्ताव: Stratium Legal ग्राहक को दायरे, सुपुर्दगियों और निश्चित मूल्य के साथ एक सेवा प्रस्ताव भेजता है — बिना बारीक अक्षरों, बिना छिपी लागत और बिना पूर्व प्रतिबद्धताओं के।",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "3. कोटेशन अनुरोध के चौबीस (24) घंटे के भीतर दायरे, सुपुर्दगियों और निश्चित मूल्य के साथ सेवा प्रस्ताव सौंपना।",
    ...
    },
    {
      ...
      paragraphs: [
        "7.1 सेवा योजनाओं के मूल्य। वर्तमान मूल्य निम्नलिखित हैं:",
        "• Starter योजना: $8,000.00 MXN (आधार मूल्य) प्लस VAT, एकमुश्त भुगतान। इसमें कंपनी का गठन, कॉर्पोरेट पुस्तकें, भागीदार पंजीकरण, पहली कार्यवाही और डिजिटल सुपुर्दगी शामिल है।",
        "• Cumplimiento Mensual योजना: $15,000.00 MXN/माह प्लस VAT, मासिक सदस्यता। इसमें वार्षिक सभा, अधिकारपत्र, निरंतर कॉर्पोरेट सलाह, श्रम प्रबंधन, 24 घंटे समर्थन और अनुस्मारक शामिल हैं।",
        "• Soft Landing योजना: $30,000.00 MXN प्लस VAT, एकमुश्त या चरणबद्ध भुगतान। इसमें निदान, गठन, पुस्तकें, कर सलाह, बैंक खाता खोलना, अधिकारपत्र और श्रम/आव्रजन मार्गदर्शन शामिल हैं।",
        "मूल्यों में VAT शामिल नहीं है, जो लागू कर कानून के अनुसार ग्राहक पर लगाया जाएगा। मूल्यों में व्यक्तिगत सलाह और पूर्ण कानूनी वैधता के साथ डिजिटल सुपुर्दगी शामिल है। Stratium Legal कम से कम तीस (30) कैलेंडर दिन पहले ग्राहक को सूचित करते हुए मूल्यों को संशोधित करने का अधिकार सुरक्षित रखता है। संशोधन पहले से अनुबंधित और भुगतान की गई सेवाओं को प्रभावित नहीं करेंगे।",
        "7.2 प्रतिपूर्ति योग्य खर्च। ग्राहक उचित और प्रलेखित खर्चों को कवर करेगा, जिसमें शामिल हैं:",
        ...
        "7.3 बिलिंग और भुगतान। Stratium Legal लागू कर कानून के अनुसार CFDI (कर चालान) जारी करेगा। Starter और Soft Landing योजनाओं (एकमुश्त भुगतान) का भुगतान सेवा के प्रावधान से पहले किया जाता है, सिवाय सेवा प्रस्ताव में सहमत चरणबद्ध भुगतान के। Cumplimiento Mensual योजना का भुगतान प्रत्येक मासिक अवधि की शुरुआत के बाद पाँच (5) कैलेंडर दिनों के भीतर किया जाता है। भुगतान Stratium Legal द्वारा निर्दिष्ट खाते में इलेक्ट्रॉनिक हस्तांतरण के माध्यम से किया जाता है। सभी शुल्क मैक्सिकन पेसो (MXN) में व्यक्त किए जाते हैं।",
        "7.4 भुगतान में चूक। चूक की स्थिति में, बकाया शेष पर देरी के प्रति दिन, देय तिथि पर प्रभावी 28-दिवसीय TIIE के दोगुने के बराबर दर पर विलंब ब्याज अर्जित होगा। यदि देरी पंद्रह (15) कैलेंडर दिनों से अधिक हो जाती है, तो Stratium Legal कम से कम पाँच (5) कार्य दिवस पहले ग्राहक को सूचित करने के बाद सेवाओं को निलंबित कर सकता है।",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• सेवाओं के अनुबंध से पहले के उल्लंघनों से उत्पन्न जुर्माने या दंड (जैसे CFF के अनुच्छेद 83 में उल्लिखित प्रति अननुपालित वर्ष $208,070 MXN तक के जुर्माने, जिनका नियमितीकरण सेवाओं का उद्देश्य है पर जिनका अधिरोपण विशेष रूप से कर अधिकारियों पर निर्भर करता है)।",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "12.1 अवधि। ये नियम उनकी स्वीकृति पर प्रभावी होते हैं और तब तक प्रभावी रहते हैं जब तक पक्षों के बीच पेशेवर संबंध मौजूद है। Cumplimiento Mensual योजना के लिए, सदस्यता हर महीने स्वचालित रूप से नवीनीकृत होती है। Starter और Soft Landing योजनाओं के लिए, संबंध सहमत सुपुर्दगियों की पूर्ण सुपुर्दगी के साथ समाप्त हो जाता है।",
        "12.2 ग्राहक द्वारा रद्दीकरण। ग्राहक किसी भी समय, कम से कम पंद्रह (15) कैलेंडर दिन पहले लिखित सूचना (info@stratiumlegal.com पर ईमेल) द्वारा सेवाओं को रद्द कर सकता है। Cumplimiento Mensual योजना के रद्दीकरण की स्थिति में, चालू महीने का कोई धनवापसी नहीं होगी। Starter या Soft Landing योजनाओं में, ग्राहक अर्जित शुल्क और पहले से किए गए खर्चों को कवर करेगा।",
...
const cn: TermsBundle = {
  ...
  lastUpdated: "最后更新：2026年6月3日 — 版本 1.0",
  disclaimer:
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "“服务提案”：载明客户所签约的特定服务的范围、交付物、固定价格和期限的具体文件，在报价请求后 24 小时内发送。它构成本条款不可分割的组成部分。",
    ...
    },
    {
      title: "3. 服务与计划说明",
      paragraphs: [
        "Stratium Legal 为墨西哥的每一法人提供专门用于遵守 LGSM、CFF 和《商法典》所规定义务的企业法律服务。这些服务涵盖完整的企业生命周期，从公司设立到其持续的年度维护，并组织为以下计划：",
        "3.1 Starter 计划 — 设立。价格：$8,000.00 MXN（捌仟比索 00/100 M.N.）外加增值税。基础价格；一次性付款。专为希望从第一天起就拥有坚实法律基础的创业者和企业设计。包括：",
        ...
        "3.2 Cumplimiento Mensual 计划 — 虚拟内部法律顾问。价格：每月 $15,000.00 MXN（壹万伍仟比索 00/100 M.N.）外加增值税。按月订阅。其作用如同一名内部企业律师，却无需相应的成本。持续覆盖公司的企业和劳动义务。包括：",
        ...
        "订阅每月自动续订，除非客户在下一周期开始前至少提前十五（15）个日历日通知取消。不包括：在诉讼中代表客户出席司法或行政机关、移民手续、商标注册、就特别交易（并购、重组）出具正式法律意见，或税务审计服务。",
        "3.3 Soft Landing 计划 — 外国公司。价格：$30,000.00 MXN（叁万比索 00/100 M.N.）外加增值税。一次性或分阶段付款，依服务提案而定。专为希望安全、高效并依照墨西哥法律在墨西哥设立的外国公司设计。包括：",
        ...
        "3.4 附加及专项服务。除上述计划外，Stratium Legal 还提供以下可独立或作为补充签约的服务：",
        ...
        "• 知识产权、并购、尽职调查及专项合同服务，须经具体报价。",
        "这些服务的范围、交付物和固定价格将在相应的服务提案中确定，该提案在请求后 24 小时内交付给客户。",
      ],
    },
    {
      title: "4. 签约流程",
      paragraphs: [
        ...
        "2. 24 小时内提案：Stratium Legal 向客户发送载明范围、交付物和固定价格的服务提案——没有小字条款、没有隐藏费用、没有事先承诺。",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "3. 在报价请求后二十四（24）小时内交付载明范围、交付物和固定价格的服务提案。",
        "4. 就所委托事项的进展及时向客户通报。",
    ...
    },
    {
      ...
      paragraphs: [
        "7.1 服务计划价格。现行价格如下：",
        "• Starter 计划：$8,000.00 MXN（基础价格）外加增值税，一次性付款。包括公司设立、公司簿册、合伙人登记、第一份会议记录和电子交付。",
        "• Cumplimiento Mensual 计划：每月 $15,000.00 MXN 外加增值税，按月订阅。包括年度大会、授权书、持续企业咨询、劳动管理、24 小时支持和提醒。",
        "• Soft Landing 计划：$30,000.00 MXN 外加增值税，一次性或分阶段付款。包括诊断、设立、簿册、税务咨询、银行开户、授权书和劳动/移民指导。",
        "价格不含增值税，增值税将依照现行税法转嫁给客户。价格包含个性化咨询和具有完全法律效力的电子交付。Stratium Legal 保留修改价格的权利，并至少提前三十（30）个日历日通知客户。修改不影响已签约并已付款的服务。",
        "7.2 可报销开支。客户将承担合理且有据可查的开支，包括：",
        ...
        "7.3 开票与付款。Stratium Legal 将依照现行税法开具 CFDI（税务发票）。Starter 和 Soft Landing 计划（一次性付款）的款项在服务提供之前支付，但服务提案中约定的分阶段付款除外。Cumplimiento Mensual 计划的款项在每个月度周期开始后的五（5）个日历日内支付。款项通过电子转账支付至 Stratium Legal 指定的账户。所有费用均以墨西哥比索（MXN）表示。",
        "7.4 逾期付款。如发生逾期，将按相当于到期日有效的 28 天期 TIIE 两倍的利率，就未清余额按逾期天数计收逾期利息。如逾期超过十五（15）个日历日，Stratium Legal 在至少提前五（5）个营业日通知客户后，可暂停服务。",
      ],
    },
    {
      title: "8. 知识产权",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "• 不可抗力或意外事件。",
        "• 因签约服务之前的违约而产生的罚款或处罚（例如 CFF 第 83 条所述每个未合规年度高达 $208,070 MXN 的罚款，其规范化属于服务的对象，但其课处完全取决于税务主管机关）。",
      ],
    },
    {
      title: "10. 职业保密与保密义务",
    ...
    },
    {
      title: "12. 有效期与终止",
      paragraphs: [
        "12.1 有效期。本条款自接受之时起生效，并在双方之间存在专业关系期间持续有效。对于 Cumplimiento Mensual 计划，订阅每月自动续订。对于 Starter 和 Soft Landing 计划，关系随约定交付物的全部交付而结束。",
        "12.2 客户取消。客户可随时通过书面通知（发送电子邮件至 info@stratiumlegal.com）并至少提前十五（15）个日历日取消服务。如取消 Cumplimiento Mensual 计划，当月不予退款。对于 Starter 或 Soft Landing 计划，客户将承担已发生的费用和已产生的开支。",
